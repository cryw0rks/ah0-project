    ...
    <header>
            ...
            <div class="content">
                ...
                <div class="content-right">
                  <div class="center-cropped profile-e"><img v-bind:src="user_image_profile"></div>
                  <h4 v-if="isLogin"><router-link :to="{ path: 'user', name: 'User Profile', params: { userId: user_username }}">{{ user_nickname }}</router-link></h4>
    ...
    export default {
        ...
        methods : {
            updateClock() {
                ...
                this.today_datez = 'japan, tokyo '+currentDate.format('D/M/YYYY, h:mm:ss a')
            },
            renderData(lol) {
        //console.log(lol);
